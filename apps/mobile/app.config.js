export default {
  expo: {
    ...
    // ─── App icon & splash ─────────────────────────────────
    // Generated by `python3 scripts/generate-icons.py` (also writes the
    // native android/ mipmaps). Sizes match EAS defaults (icon 1024,
    // splash 1284×2778, adaptive 1024, favicon 48, notification 96).
