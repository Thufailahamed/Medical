...
export default function BookAppointmentScreen() {
  ...
  const filteredTimes = TIME_SLOTS.filter((t) => {
          ...
          <View style={{ gap: spacing.md }}>
            <View style={{ gap: spacing.xs }}>
              ...
              <Text style={[typography.body.sm, { color: colors.textMuted }]}>
                Pick a specialty — full doctor network coming soon.
              </Text>
            </View>
            ...
            <View style={{ gap: spacing.sm }}>
              {filteredSpecialties.map((s) => {
                const selected = values.doctorId === s;
                return (
                  <NextActionCard
                    key={s}
                    subject={s}
                    verb="Available today"
                    context="Tap to choose"
                    icon={Stethoscope}
                    iconTone="primary"
                    trailing={
                      selected ? (
                    ...
                    onPress={() => {
                      setValue("doctorId", s, { shouldValidate: true });
                      setValue("hospitalId", "h_" + s, {
                        shouldValidate: true,
                      });
                    }}
                  />
            ...
            <Card>
              <View style={{ gap: spacing.md }}>
                ...
                <SummaryRow
                  ...
                  value={
                    values.hospitalId
                      ? `Hospital #${values.hospitalId.slice(-4)}`
                      : "—"
                  }
                />
                <SummaryRow
