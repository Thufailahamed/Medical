...
export default function AppLayout() {
  ...
  return (
    ...
    >
      ...
      {/* Book a Test — diagnostic test home collection */}
      <Tabs.Screen
        name="test-catalog"
        options={{ href: null, tabBarStyle: { display: "none" } }}
      />
      <Tabs.Screen
        name="test-detail/[slug]"
        options={{ href: null, tabBarStyle: { display: "none" } }}
      />
      <Tabs.Screen
        name="test-packages"
      ...
      {/* Hidden Insurance Module Routes */}
      <Tabs.Screen
      ...
      />
      <Tabs.Screen
        name="insurance/marketplace/[providerId]"
        options={{ href: null, tabBarStyle: { display: "none" } }}
      />
      <Tabs.Screen
      ...
      />
      <Tabs.Screen
        name="insurance/claims/[id]"
        options={{ href: null, tabBarStyle: { display: "none" } }}
      />
      <Tabs.Screen
        name="insurance/claims/new"
        options={{ href: null, tabBarStyle: { display: "none" } }}
      />
      <Tabs.Screen
        name="insurance/ecard/[id]"
        options={{ href: null, tabBarStyle: { display: "none" } }}
      />
      <Tabs.Screen
        name="insurance/enroll/[planId]"
        options={{ href: null, tabBarStyle: { display: "none" } }}
      />
      <Tabs.Screen
