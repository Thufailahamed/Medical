...
const PROVIDERS: ProviderSeed[] = [
  {
    ...
    plans: [
      ...
      {
        slug: "ceylinco-critical-cover",
        name: "Critical Cover Plus",
        planType: "critical_illness",
        coverageSummaryLkr: 3_500_000,
        monthlyPremiumLkr: 4600,
        annualPremiumLkr: 51_000,
        annualDiscountPct: 8,
        copayPct: 0,
  ...
  },
  {
    ...
    plans: [
      ...
      {
        slug: "ua-family-comfort",
        name: "Family Comfort",
        planType: "family_floater",
        coverageSummaryLkr: 5_000_000,
        monthlyPremiumLkr: 5900,
        annualPremiumLkr: 65_000,
        annualDiscountPct: 9,
        copayPct: 15,
        networkHospitalCount: 180,
        waitingPeriodDays: 30,
  ...
  },
  {
    ...
    plans: [
      ...
      {
        slug: "aia-smile-dental",
        name: "Smile Dental Care",
        planType: "dental",
        coverageSummaryLkr: 800_000,
        monthlyPremiumLkr: 1450,
        annualPremiumLkr: 16_000,
        annualDiscountPct: 8,
        copayPct: 15,
      ...
      {
        slug: "aia-healthy-family",
        name: "Healthy Family",
        planType: "family_floater",
        coverageSummaryLkr: 9_000_000,
        monthlyPremiumLkr: 9200,
        annualPremiumLkr: 101_000,
        annualDiscountPct: 10,
        copayPct: 15,
        networkHospitalCount: 260,
        waitingPeriodDays: 30,
  ...
  },
  {
    ...
    plans: [
      ...
      {
        slug: "hnb-silver-senior",
        name: "Silver Senior Plan",
        planType: "senior",
        coverageSummaryLkr: 3_500_000,
        monthlyPremiumLkr: 4800,
        annualPremiumLkr: 53_000,
        annualDiscountPct: 9,
        copayPct: 20,
        networkHospitalCount: 150,
        waitingPeriodDays: 60,
      ...
      {
        slug: "hnb-critical-assist",
        name: "Critical Assist",
        planType: "critical_illness",
        coverageSummaryLkr: 2_500_000,
        monthlyPremiumLkr: 3700,
        annualPremiumLkr: 41_000,
        annualDiscountPct: 8,
        copayPct: 0,
        networkHospitalCount: 80,
        waitingPeriodDays: 90,
  ...
  },
  {
    ...
    plans: [
      ...
      {
        slug: "softlogic-family-shield",
        name: "Family Shield",
        planType: "family_floater",
        coverageSummaryLkr: 4_500_000,
        monthlyPremiumLkr: 5400,
        annualPremiumLkr: 59_000,
        annualDiscountPct: 8,
        copayPct: 15,
        networkHospitalCount: 130,
        waitingPeriodDays: 30,
  ...
  },
  {
    ...
    plans: [
      ...
      {
        slug: "continental-cancer-shield",
        name: "Cancer Shield",
        planType: "cancer",
        coverageSummaryLkr: 5_500_000,
        monthlyPremiumLkr: 6200,
        annualPremiumLkr: 68_000,
        annualDiscountPct: 8,
        copayPct: 0,
        networkHospitalCount: 70,
        waitingPeriodDays: 60,
